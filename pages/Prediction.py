...
photo_url = Image.open("resources/images/laptop.jpg")
...
DATA_PATH = os.path.join(dir_of_interest, "data", "modified_laptop_data.csv")
...
st.write(':blue[Enter the details below to predict Price of a product]')
